...
export class BallotApi {
    ...
    public setApiKey(key: BallotApiApiKeys, value: string) {
        (this.authentications as any)[BallotApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param id Universally Unique IDentifier (UUID) 
     */
    public async deleteBallotItem (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/ballots/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        let localVarFormParams: any = {};
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling deleteBallotItem.');
        }
     ...
     * @param id Universally Unique IDentifier (UUID) 
     */
    public async getBallotItem (id: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BallotjsonldRead;  }> {
        const localVarPath = this.basePath + '/ballots/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getBallotItem.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: BallotjsonldRead;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "BallotjsonldRead");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
     ...
     */
    public async postBallotCollection (pollId: string, proposalId: string, ballotjsonldCreate?: BallotjsonldCreate, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BallotjsonldCreated;  }> {
        const localVarPath = this.basePath + '/polls/{pollId}/proposals/{proposalId}/ballots'
            .replace('{' + 'pollId' + '}', encodeURIComponent(String(pollId)))
            .replace('{' + 'proposalId' + '}', encodeURIComponent(String(proposalId)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'pollId' is not null or undefined
        if (pollId === null || pollId === undefined) {
            throw new Error('Required parameter pollId was null or undefined when calling postBallotCollection.');
        }

        // verify required parameter 'proposalId' is not null or undefined
        if (proposalId === null || proposalId === undefined) {
            throw new Error('Required parameter proposalId was null or undefined when calling postBallotCollection.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(ballotjsonldCreate, "BallotjsonldCreate")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: BallotjsonldCreated;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "BallotjsonldCreated");
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
                        }
